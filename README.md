...
InveStats is a responsive stock trading app, where users can buy and sell from thousands of stocks. Up-to-date price charts, financial data, and news are displayed so that users can make the most informed decision.
